...
const CataxComp = ({
    ...
    return (
        <div className=" ">
            <div className="w-[36vw] bg-white p-5 rounded-lg shadow-lg border">
                        ...
                        <div className="flex gap-6 w-full">
                            {files[exchangeKey].map((file, index) => (
                                <FileInput
                                    ...
                                    txn_type={`Txn type: ${dataFields[exchangeIndex].files_detail[index].txn_type === 'crypto_deposit' ? 'Dep/With' : 'Trade'}`}
                ...
                <div className="text-center">
                    {uploadProgress > 0 && (
                        <div className="w-full bg-[#a64d79] rounded-full h-4 mb-4">
                            <div
                                className="bg-[#c6528c] h-4 rounded-full"
                    ...
                    <button
                        onClick={uploadFiles}
                        className={`${uploadProgress > 0 ? "bg-[#c6528c]" : "bg-[#a64d79]"
...
const FileInput = ({
    ...
    <div className="flex items-center justify-center w-52 h-44 border rounded-md bg-white">
        {uploadedFile ? (
            ...
            <label className="flex flex-col items-center justify-center w-full h-full cursor-pointer">
                <TbCloudUpload size={40} className="text-[#a64d79] mb-4" />
                <span className="bg-[#a64d79] text-white px-4 py-2 text-sm font-semibold mb-2">
                    Browse File
                </span>
                <input
                    type="file"
